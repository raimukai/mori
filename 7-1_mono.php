<?php
    ...
    $date = date("Y-m-d");
    $sql = "CREATE TABLE IF NOT EXISTS mono"
    ." ("
...
<div class="center">
<h1>モノフォーム</h1>
<form method="POST" action="7-1_mono.php">
<p>貸す相手
...
if(isset($_POST["touroku"]))
    ...
    {
        $sql = $pdo -> prepare("INSERT INTO mono (ait, thing, day, eday, lort, tuuti, memo) VALUES (:ait, :thing, :day, :eday, :lort,:tuuti, :memo)");
...
if(isset($_POST["del"]))
{
   if (!empty($_POST["ait2"])) 
   {
         ...
         foreach ($results as $row)
         {
            ...
            {
                $id = $_POST["ait2"];
                $sql = 'delete from mono where id=:id';
